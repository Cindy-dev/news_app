...
class TechCatScreen extends StatefulWidget {
  const TechCatScreen({Key? key}) : super(key: key);

  @override
  State<TechCatScreen> createState() => _TechCatScreenState();
}

class _TechCatScreenState extends State<TechCatScreen> {
              ...
              return vm.when(data: (data) {
                ...
                return sortedArticles!.isEmpty
                    ? Container(
                        ...
                        child:
                            Text("No news available for TECHNOLOGY at the moment"),
                      )
                    : Expanded(
                ...
                return Text("Technology News Error: $err'");
              }, loading: () {
                return Expanded(
                  child: ListView.builder(
                      shrinkWrap: true,
