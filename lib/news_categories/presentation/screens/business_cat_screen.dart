...
class BusinessCatScreen extends StatefulWidget {
  const BusinessCatScreen({Key? key}) : super(key: key);

  @override
  State<BusinessCatScreen> createState() => _BusinessCatScreenState();
}

class _BusinessCatScreenState extends State<BusinessCatScreen> {
        ...
        child: Column(
          children: [
            ...
            Consumer(builder: (_, ref, child) {
              final vm = ref.watch(newsBusinessCatVM(selectedCountry));
              return vm.when(data: (data) {
                ...
                return sortedArticles!.isEmpty
                    ? Container(
                        ...
                        child: Text(
                            "No news available for BUSINESS at the moment"),
                      )
                    : Expanded(
