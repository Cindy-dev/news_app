...
class ScienceCatScreen extends StatefulWidget {
  const ScienceCatScreen({Key? key}) : super(key: key);

  @override
  State<ScienceCatScreen> createState() => _ScienceCatScreenState();
}

class _ScienceCatScreenState extends State<ScienceCatScreen> {
        ...
        child: Column(
          children: [
            ...
            Consumer(builder: (_, ref, child) {
              final vm = ref.watch(newsScienceCatVM(selectedCountry));
              return vm.when(data: (data) {
                ...
                return sortedArticles!.isEmpty
                    ? Container(
                        ...
                        child:
                            Text("No news available for SCIENCE at the moment"),
                      )
                    : Expanded(
                ...
                return Text("Science News Error: $err'");
              }, loading: () {
                return Expanded(
                  child: ListView.builder(
                      shrinkWrap: true,
