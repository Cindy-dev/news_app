...
class HealthCatScreen extends StatefulWidget {
  const HealthCatScreen({Key? key}) : super(key: key);

  @override
  State<HealthCatScreen> createState() => _HealthCatScreenState();
}

class _HealthCatScreenState extends State<HealthCatScreen> {
        ...
        child: Column(
          children: [
            ...
            Consumer(builder: (_, ref, child) {
              final vm = ref.watch(newsHealthCatVM(selectedCountry));
              return vm.when(data: (data) {
                ...
                return sortedArticles!.isEmpty
                    ? Container(
                        ...
                        child:
                            Text("No news available for HEALTH at the moment"),
                      )
                    : Expanded(
                ...
                return Text("Health News Error: $err'");
              }, loading: () {
                return Expanded(
                  child: ListView.builder(
                      shrinkWrap: true,
