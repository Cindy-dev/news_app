...
class EntertainmentCatScreen extends StatefulWidget {
  const EntertainmentCatScreen({Key? key}) : super(key: key);

  @override
  State<EntertainmentCatScreen> createState() => _EntertainmentCatScreenState();
}

class _EntertainmentCatScreenState extends State<EntertainmentCatScreen> {
        ...
        child: Column(
          children: [
            ...
            Consumer(builder: (_, ref, child) {
              final vm = ref.watch(newsEntertainmentCatVM(selectedCountry));
              return vm.when(data: (data) {
                ...
                return sortedArticles!.isEmpty
                    ? Container(
                        ...
                        child: Text(
                            "No news available for ENTERTAINMENT at the moment"),
                      )
                    : Expanded(
                ...
                return Text("Entertainment News Error: $err'");
              }, loading: () {
                return Expanded(
                  child: ListView.builder(
                      shrinkWrap: true,
